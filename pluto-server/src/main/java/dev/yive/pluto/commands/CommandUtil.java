    ...
    public static List<String> getListMatchingLast(
        ...
        if (!collection.isEmpty()) {
            ...
            while (iterator.hasNext()) {
                ...
                if (matches(last, s1) && (sender.hasPermission(PlutoCommand.BASE_PERM + s1) || sender.hasPermission("bukkit.command.pluto"))) {
                    results.add(s1);
                }
            }
            ...
            if (results.isEmpty()) {
                ...
                while (iterator.hasNext()) {
                    ...
                    if (object instanceof Identifier identifier && matches(last, identifier.getPath())) {
