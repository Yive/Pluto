...
public class PufferfishVersionFetcher implements VersionFetcher {
	...
	private static final URI JENKINS_URI = URI.create("https://ci.yive.dev/job/Pluto/job/1.21.9/lastSuccessfulBuild/buildNumber");
	private static final String GITHUB_FORMAT = "https://api.github.com/repos/Yive/Pluto/compare/ver/1.21.9...%s";
	// Pluto end - Branding
