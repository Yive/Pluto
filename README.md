...
## API
You can find the javadocs [here](https://repo.yive.dev/javadoc/snapshots/dev/yive/pluto/pluto-api/26.3-R0.1-SNAPSHOT).
...
<dependencies>
    <dependency>
        ...
        <version>26.3-R0.1-SNAPSHOT</version>
...
dependencies {
    compileOnly 'dev.yive.pluto:pluto-api:26.3-R0.1-SNAPSHOT'
}
```
...
dependencies {
    paperweight.devBundle("dev.yive.pluto", "26.3-R0.1-SNAPSHOT")
}
```
