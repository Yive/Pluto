...
## API
You can find the javadocs [here](https://repo.yive.dev/javadoc/snapshots/dev/yive/pluto/pluto-api/1.21.6-R0.1-SNAPSHOT).
...
dependencies {
    compileOnly 'dev.yive.pluto:pluto-api:1.21.6-R0.1-SNAPSHOT'
}
```
...
dependencies {
    paperweight.devBundle("dev.yive.pluto", "1.21.6-R0.1-SNAPSHOT")
}
```
