...
## API
You can find the javadocs [here](https://repo.yive.dev/javadoc/snapshots/dev/yive/pluto/pluto-api/26.1.2).
...
dependencies {
    compileOnly 'dev.yive.pluto:pluto-api:26.1.2'
}
```
...
dependencies {
    paperweight.devBundle("dev.yive.pluto", "26.1.2")
}
```
